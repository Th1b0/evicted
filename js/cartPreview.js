...
const products = [
  {
    id: "3",
    desc: "Meet the AirRep Pro with ANC – 35dB noise cancellation, seamless iOS integration, and extended battery life.",
    name: "AirRep Pro",
    price: 54.99,
    img: "./img/AirReps-32434.png",
  },
  {
    id: "4",
    desc: "Meet the AirRep Pro 2 with ANC – 35dB noise cancellation, seamless iOS integration, and extended battery life.",
    name: "AirRep Pro 2",
    price: 58.99,
    img: "./img/AirReps-32434.png",
  },
  {
    id: "1",
    desc: "Meet the AirRep 3th Gen, seamless iOS integration.",
    name: "AirRep 3th Gen",
    price: 49.99,
  ...
  {
    id: "2",
    desc: "Meet the AirRep 2th Gen, seamless iOS integration.",
    name: "AirRep 2th Gen",
    price: 44.99,
    img: "./img/550x531-PhotoRoom.png-PhotoRoom.png",
  },
